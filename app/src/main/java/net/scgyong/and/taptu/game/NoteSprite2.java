...
public class NoteSprite2 extends Sprite implements Recyclable {
    ...
    public static NoteSprite2 get(Song.Note note, float time) {
        NoteSprite2 ns = (NoteSprite2) RecycleBin.get(NoteSprite2.class);
        if (ns == null) {
            ns = new NoteSprite2();
        }
        ns.init(note, time);
    ...
    private NoteSprite2() {
        super(0, 0, Metrics.width * NOTE_WIDTH, Metrics.width * NOTE_HEIGHT, R.mipmap.n2);
