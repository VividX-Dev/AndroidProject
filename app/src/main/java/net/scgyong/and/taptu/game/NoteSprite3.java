...
public class NoteSprite3 extends Sprite implements Recyclable {
    ...
    public static NoteSprite3 get(Song.Note note, float time) {
        NoteSprite3 ns = (NoteSprite3) RecycleBin.get(NoteSprite3.class);
        if (ns == null) {
            ns = new NoteSprite3();
        }
        ns.init(note, time);
    ...
    private NoteSprite3() {
        super(0, 0, Metrics.width * NOTE_WIDTH, Metrics.width * NOTE_HEIGHT, R.mipmap.n3);
    ...
    public void update(float frameTime) {
        ...
        setCenter((float) (x+frameTime*speed*0.15),y+speed*frameTime);
